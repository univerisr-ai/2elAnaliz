...
export async function generateFinalExpertSummary(topCandidates) {
  ...
  const prompt = [
    ...
    'Aşağıdaki matematiksel olarak en karlı duran GPU ekran kartı ilanlarını (başlık, piyasa değeri ve fiyatlarına göre) incele.',
    ...
    'Görevin: Şüpheli ve riskli olanları tamamen eleyip, MANTIKEN ve GÜVENLE alınabilecek olan tüm ekran kartlarını sıralamak. Tavan sayı yok, sadece filtreyi geçebilen temiz ilanları listele.',
    'JSON formatı KULLANMA. Kullanıcı telgrafa gönderecek.',
    'Lütfen net ve kısa bir liste hazırla.',
    'Format: (id numarasını gösterme, kartın net adını ve fiyatını yaz)',
    '- [GPU Model / Başlık Kısaltması] - [Fiyat] TL',
    '  💡 [Seçim sebebin ve başlıktaki temizlik hissiyatı (Örn: İlan başlığı temiz duruyor, fiyat mantıklı)]',
    '',
